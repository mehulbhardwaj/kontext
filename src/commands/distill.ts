    ...
    program
        ...
        .action(async () => {
            ...
            if (!fs.existsSync(decisionsDir)) {
                console.log("No decisions to distill.");
                return;
            }
            ...
            if (files.length < 2) {
                console.log(chalk.green("✅ Context is already minimal."));
                return;
            }
            ...
            console.log(chalk.dim(`Analyzing ${files.length} decisions...`));
            ...
            if (confirm) {
                ...
                // B. Delete old files
                // Critical safety check: Don't delete the file we just wrote if it was one of the originals being updated
